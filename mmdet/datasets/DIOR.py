...
class DIOR(XMLDataset):
    ...
    def __init__(self,  version, *args, **kwargs):
        ...
        super(DIOR, self).__init__(*args, **kwargs)
    ...
    def load_annotations(self, ann_file):
        ...
        for img_id in img_ids:
            ...
            xml_path = osp.join(self.data_root, 'Annotations/Oriented Bounding Boxes',
                                f'{img_id}.xml')
    ...
    def get_ann_info(self, idx):
        ...
        xml_path = osp.join(self.data_root, 'Annotations/Oriented Bounding Boxes', f'{img_id}.xml')
        tree = ET.parse(xml_path)
        root = tree.getroot()
        bboxes = []
        hbboxes = []
        ...
        for obj in root.findall('object'):
            ...
            _rbbox = poly2obb_np(poly, self.version)
            if _rbbox is None:
                continue
            rbbox = list(_rbbox)

            hbbox = [poly[::2].min(), poly[1::2].min(), poly[::2].max(), poly[1::2].max()]
    ...
    def evaluate(self,
        ...
        if metric == 'mAP':
            ...
            if results[0][0].shape[1] == 5:
                ...
                # iou_thr_list = [0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95]
                real = 0
