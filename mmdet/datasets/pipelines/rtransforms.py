    ...
    def __call__(self, results):
        ...
        Returns:
            dict: Flipped results, 'flip', 'flip_direction' keys are added \
                into result dict.
        """
        aug_dict = {'horizontal': False, 'vertical': False, 'diagnal': False}
        ...
        if 'flip' not in results:
            ...
            # index = 0
            for index, direction_item in enumerate(self.direction):
        ...
        #                    out_file='/home/oneco/xyh/rotate_detection/vis_diag/' + str(int(time.time() % 1000)) + '.png',
        #                    version='v1')
