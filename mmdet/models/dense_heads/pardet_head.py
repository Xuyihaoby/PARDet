...
class PARDetHead(AnchorHead):
    def __init__(self,
        ...
        super(PARDetHead, self).__init__(
            num_classes,
            in_channels,
    ...
    def loss_single(self, cls_score, bbox_pred, pt_pred, anchors, anchor_points, labels, label_weights,
        ...
        self.gmm.fit(_minus_pos_set, n_iter=self.n_iter)
        ...
        pointsJf(_center_pos * stride[0], obb2poly(_select_target_unique), inside_flag_1)
        # pointsJf(_center_pos * stride[0], obb2poly(_select_target), inside_flag_2)
        pointsJfAlign(_center_pos * stride[0], obb2poly(_select_target), inside_flag_2)
        ...
        if len(pos_index) > 0:
            ...
            pt_targets = obb2poly(bbox_targets[pos_index]) / 1024
