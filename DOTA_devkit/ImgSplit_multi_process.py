...
if __name__ == '__main__':
    ...
    split_val_ms = splitbase(r'/data/Aerial/DOTA1_0/origin/train',
                              r'/data/Aerial/DOTA1_0/simple/train200',
                              gap=200,
                              subsize=1024,
                              num_process=32)
    ...
    split_train_ms = splitbase(r'/data/Aerial/DOTA1_0/origin/val',
                               r'/data/Aerial/DOTA1_0/simple/val200',
                               gap=200,
                               subsize=1024,
                               num_process=32)
