...
from mmdet.models.backbones.orient1d import Orient1D
...
def convnext_tiny(variant='2d', **kwargs):
    return Orient1D(depths=[3, 3, 9, 3], dims=[96, 192, 384, 768], variant=variant, **kwargs)

def convnext_base( variant='2d',  **kwargs):
    return Orient1D(depths=[3, 3, 27, 3], dims=[128, 256, 512, 1024], variant=variant, **kwargs)
